...
export const defaultConfig: Config = {
  blockCssClass: 'gfm-alert',
  titleCssClass: 'gfm-alert-title',
  types: {
    '[!NOTE]': {
    ...
    '[!IMPORTANT]': {
      ...
      title: 'Important',
      cssClass: 'gfm-alert-type-important'
    },
    '[!WARNING]': {
      // MIT License - Copyright (c) 2023 GitHub Inc. <https://github.com/primer/octicons>
      svgIcon:
      ...
      title: 'Warning',
      cssClass: 'gfm-alert-type-warning'
    },
    '[!CAUTION]': {
      // MIT License - Copyright (c) 2023 GitHub Inc. <https://github.com/primer/octicons>
      svgIcon:
      ...
      title: 'Caution',
      cssClass: 'gfm-alert-type-caution'
    }
  }
}
